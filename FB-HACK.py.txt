...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: MR.MUIIN             |"
    print GL+"  |       BANGLADESH DHAKA UTTARA        |"
    print WW+"  |        TEAM : BANGLADESH CYBER ErRoR SyStEm            |"
    print Y+"  |             FLOWME: https://www.facebook.com/mithen.chowdhuri.7              |"
    print GL+"  |---------------------------------------------|"
